...
(function() {
    ...
    appModule.factory('loginService', ['baseUrlService', function(baseUrlService) {
        ...
        return function loginService(userName, password) {
            ...
            baseUrlPromise.done(function baseUrlRetrieved(baseUrl) {
                lsiexports.post(baseUrl + '/login', window.JSON.stringify({ username: userName, password: password })).done(function() {
                    loggingIn.resolve();
    ...
    appModule.factory('loadListService', ['baseUrlService', function(baseUrlService) {
        var baseUrlPromise = baseUrlService();
        return function loadListService(bypassCache) {
    ...
    appModule.controller('IrmaExtensionCtrl', ['$scope', 'loadListService', 'loadCredentialService', 'loginService', 'searchTriggerService', function($scope, loadListService, loadCredentialService, loginService, searchTriggerService) {
        $scope.list = null;
        ...
        $scope.loadListData = function loadListData(bypassCache) {
            ...
            ensureLoggedIn().done(function authenticated() {
                ...
                loadListService(bypassCache).done(function listLoaded(loadedList) {
