...
module.exports = {
    registerEndpoints: function(app) {
        ...
        app.get('/list', auth.checkAuth, function(req, res) {
            var group = req.group;
        ...
        app.get('/fulljson', auth.checkAuth, function(req, res) {
            var group = req.group;
         ...
         * POST list json
         */
        app.post('/list', auth.checkAuth, function(req, res) {
            var group = req.group;
            ...
            ShoppingListModel.findOne({_id: req.body._id, ownerGroup: group._id }, function(err, list) {
                ...
                model.save(function(err, list) {
                    if(err) {
                        ...
                        //Notify other clients that this list has been updated
                        sse.onListUpdate(model._id);
                    }
